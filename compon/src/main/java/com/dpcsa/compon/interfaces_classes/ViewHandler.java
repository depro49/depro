...
public class ViewHandler {
    ...
    public enum TYPE {NAME_FRAGMENT, CLOSE_DRAWER, OPEN_DRAWER, MODEL_PARAM, KEY_BACK, SET_TOKEN,
        BACK, BACK_MES, PREFERENCE_SET_VALUE, PAGER_PLUS, PREFERENCE_SET_TOKEN, PREFERENCE_SET_NAME,
        FIELD_WITH_NAME_FRAGMENT, SELECT, SET_PARAM, EXEC, UPDATE_DATA, RESULT_PARAM, NEXT_SCREEN_SPLASH,
        ...
        CLICK_SEND, SEND_UPDATE, SEND_CHANGE_BACK, ACTUAL, GET_DATA, CALL_UP, DIAL_UP, SET_PROFILE}
    public TYPE type;
