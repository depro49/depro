...
public class ComponToolBar extends RelativeLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            titleColor = a.getColor(R.styleable.Simple_titleColor, 0xFF000000);
            titleSize = a.getDimension(R.styleable.Simple_titleSize, SP_20);
            try {
                h_tool = a.getDimensionPixelSize(R.styleable.Simple_android_layout_height, 0);
            } catch (RuntimeException e) {
                h_tool = 0;
            }

            imgPadding = a.getDimensionPixelSize(R.styleable.Simple_imgPadding, 0);
        ...
        if (id != 0 && ik < 4) {
            ...
            switch (typeId) {
                ...
                case "layout":       // View
                    ...
                    lp = new RelativeLayout.LayoutParams(WRAP_CONTENT, h_tool);
                    vg.addView(VI);
                    res = vg;
